...
adding more core. The following table resume the time needed by the algorithm 
to explore $\mathcal{T}_{50}$ on diffenent number of threads (the double 
vertical line delimites the use of \texttt{Hyper Threadind}):
\begin{figure}[h!]
